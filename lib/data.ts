...
You can then scan news articles directly from your browser in real-time.`,
    ...
    { id: "p9", title: "Agentic AI Project", description: "Autonomous AI agent with reasoning and multi-step task execution.", category: "ai", tags: ["Agentic AI", "LLM"], emoji: "🤖" },
    {
        id: "p10",
    ...
    { id: "p12", title: "Customer Churn — Big Data", description: "Large-scale analysis identifying key customer attrition factors.", category: "data", tags: ["Big Data", "Pandas"], emoji: "📊" },
    {
        id: "p13",
