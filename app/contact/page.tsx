        ...
        <div className="pt-24 sm:pt-32 pb-16 sm:pb-24">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-16 items-start">
                ...
                <div ref={infoRef.ref} className={`space-y-4 sm:space-y-6 ${infoRef.visible ? 'animate-reveal-up' : 'opacity-0'}`}>
                    ...
                    {[
                        { icon: Mail, label: "Email", value: "alimaaz1501@gmail.com", href: "mailto:alimaaz1501@gmail.com" },
                        { icon: Phone, label: "Phone", value: "+91 8780837840", href: "tel:+918780837840" },
                        ...
                        return (
                            <div key={i} className="glass-card rounded-xl p-4 sm:p-5 flex items-center gap-4 group">
                                <IconComponent className="w-5 h-5 sm:w-6 sm:h-6 text-indigo-400 shrink-0 group-hover:scale-110 transition-transform duration-300" strokeWidth={1.5} />
